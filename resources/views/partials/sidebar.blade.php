<nav class="sidebar ">
    ...
    <div class="col-12 sidebar-wrapper">
        ...
        <div class="mb-4 d-flex flex-row-no-rtl">
            ...
            <div class="pl-2 d-flex justify-content-center flex-column">
                <div class=""><span class=""><span>@</span>u1677771575</span>
                </div>
                <small class="p-0 m-0"> 0 fans - 0 following</small>
            </div>
        </div>
    </div>
    ...
    <ul class="list-unstyled menu-elements p-0">
        <li class="">
            <a class="scroll-link d-flex align-items-center" href="{{url('profile')}}">
        ...
        <li class="">
            <a class="scroll-link d-flex align-items-center" href="{{url('bookmarks')}}">
                <div class="ion-icon-wrapper mr-2 icon-medium">
                    <div class="ion-icon-inner">
        ...
        <li class="">
            <a class="scroll-link d-flex align-items-center" href="{{url('lists')}}">
                <div class="ion-icon-wrapper mr-2 icon-medium">
                    <div class="ion-icon-inner">
        ...
        <li>
            <a class="scroll-link d-flex align-items-center" href="{{url('help')}}">
                <div class="ion-icon-wrapper mr-2 icon-medium">
                    <div class="ion-icon-inner">
        ...
        <li>
            ...
            <ul class="collapse list-unstyled" id="otherSections">
                <li>
                    <a class="scroll-link d-flex align-items-center" href="https://watchmevip.com/language/en">English</a>
                </li>
                <li>
                    <a class="scroll-link d-flex align-items-center" href="https://watchmevip.com/language/ro">Romanian</a>
                </li>
            </ul>
        </li>
        <div class="menu-divider"></div>
        <li>
            ...
            <form id="logout-form" action="https://watchmevip.com/logout" method="POST" class="d-none">
                <input type="hidden" name="_token" value="ukJm0v0xFIfnJYSriVUzY1tZCFl3QBVlybHYZxM8"> </form>
        </li>
    </ul>
</nav>
